  ...
  const onDrop = useCallback(
    async (acceptedFiles) => {
      ...
      try {
        ...
        // Backend returns: { statusCode: 200, data: { url, filename, ... }, ... }
        if (response.data) {
    ...
    >
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center gap-1.5 text-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="size-6 text-slate-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
